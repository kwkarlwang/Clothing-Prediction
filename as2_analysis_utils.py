...
class OrdinalClassifier():
    """Ordinal Classifier based on any binary 
    classifier. See https://towardsdatascience.com/simple-trick-to-train-an-ordinal-regression-with-any-classifier-6911183d2a3c
    """
